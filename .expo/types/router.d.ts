...
declare module "expo-router" {
  ...
  // prettier-ignore
  type StaticRoutes = `/` | `/(auth)/login` | `/login` | `/(auth)/signup` | `/signup` | `/(auth)/_layout` | `/_layout` | `/(onboarding)/component/topView` | `/component/topView` | `/(onboarding)/data` | `/data` | `/(onboarding)/dot` | `/dot` | `/(onboarding)/` | `/(onboarding)` | `/(onboarding)/onboardingData` | `/onboardingData` | `/(onboarding)/onboardingDTO` | `/onboardingDTO` | `/(tabs)/calender/` | `/calender/` | `/(tabs)/calender` | `/(tabs)/calender/_layout` | `/calender/_layout` | `/(tabs)/holidays/` | `/holidays/` | `/(tabs)/holidays` | `/(tabs)/holidays/_layout` | `/holidays/_layout` | `/(tabs)/home/` | `/home/` | `/(tabs)/home` | `/(tabs)/home/_layout` | `/home/_layout` | `/(tabs)/members/` | `/members/` | `/(tabs)/members` | `/(tabs)/members/_layout` | `/members/_layout` | `/(tabs)/profile/` | `/profile/` | `/(tabs)/profile` | `/(tabs)/profile/_layout` | `/profile/_layout` | `/(tabs)/_layout` | `/+html`;
  // prettier-ignore
